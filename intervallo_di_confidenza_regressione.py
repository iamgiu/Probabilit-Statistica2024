...
def intervallo_di_confidenza(A, B, x, y, giorno, SSr):
    n = len(x)
    ...
    margin_of_error = t_value * s_err * np.sqrt(1/n + (giorno - x_mean)**2 / Sxx)
...
# Calcola l'intervallo di confidenza al 95% per il giorno 11
y_est, lower_bound, upper_bound = intervallo_di_confidenza(A, B, x, y, giorno, SSr)
print(f"L'intervallo di confidenza al 95% è: ({lower_bound:.2f}, {upper_bound:.2f})")
